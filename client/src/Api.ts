...
export interface BalanceTopUpValue {
    topUpValue: number
}
...
export type ValueTupleOfCurrentBalanceDtoAndListOfAutomatedTicketsDto = {
    currentBalance: CurrentBalanceDto,
    automatedTickets: AutomatedTicketsDto[]
};
...
export class HttpClient<SecurityDataType = unknown> {
    ...
    constructor({securityWorker, secure, format, ...axiosConfig}: ApiConfig<SecurityDataType> = {}) {
        this.instance = axios.create({...axiosConfig, baseURL: axiosConfig.baseURL || "https://server-844014329852.europe-north1.run.app"});
        this.secure = secure;
        this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    api = {
        ...
        resetPassword: (data: ResetPasswordRequest, params: RequestParams = {}) =>
            this.request<ResetPasswordResponse>({
         ...
         *
         * @tags Payment
         * @name PaymentGetUserPendingPayments
         * @request GET:/api/adminPayment/pendingPayments
         * @secure
         */
        ...
        paymentUploadImage: (
            ...
            this.request<UpdatedBalanceResponse, any>({
                ...
                body: (() => {
                    ...
                    formData.append("topUpValue", topUpValue.toString());
    ...
    topUpPrices = {
        ...
        configurationGetTopUpPrices: (params: RequestParams = {}) =>
            this.request<BalanceTopUpValue[], any>({
                path: `/topUpPrices`,
                method: "GET",
                secure: true,
                format: "json",
